...
read -p "N8N_CONTACT_WEBHOOK_URL: " N8N_CONTACT_WEBHOOK_URL
read -p "N8N_REVIEWS_WEBHOOK_URL: " N8N_REVIEWS_WEBHOOK_URL

# Crear archivo .env
cat > .env << EOF
PORTFOLIO_TOKEN=${PORTFOLIO_TOKEN}
N8N_CONTACT_WEBHOOK_URL=${N8N_CONTACT_WEBHOOK_URL}
N8N_REVIEWS_WEBHOOK_URL=${N8N_REVIEWS_WEBHOOK_URL}
EOF
