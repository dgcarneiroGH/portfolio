...
set /p N8N_CONTACT_WEBHOOK_URL="N8N_CONTACT_WEBHOOK_URL: "
set /p N8N_REVIEWS_WEBHOOK_URL="N8N_REVIEWS_WEBHOOK_URL: "

REM Crear archivo .env
(
echo PORTFOLIO_TOKEN=%PORTFOLIO_TOKEN%
echo N8N_CONTACT_WEBHOOK_URL=%N8N_CONTACT_WEBHOOK_URL%
echo N8N_REVIEWS_WEBHOOK_URL=%N8N_REVIEWS_WEBHOOK_URL%
) > .env
